...
var t1 = document.getElementsByClassName("matrix")[0];
tabularNestHeader(t1);
//var t1rows = t1.querySelectorAll("tr");
//for (var i = 0; i < t1rows.length; i++) {
    // Remove row name from matrix
//    t1rows[i].removeChild(t1rows[i].firstElementChild);
//}

var t2 = document.getElementsByClassName("matrix")[1];
tabularNestHeader(t2);

var t3 = document.getElementsByClassName("matrix")[2];
tabularNestHeader(t3);

//var t4 = document.getElementsByClassName("matrix")[3];
//tabularNestHeader(t4);

var td = document.querySelectorAll("td");
for (var i = 0; i < td.length; i++) {
    if (td[i].textContent == "NaN (NA)" || td[i].textContent == "0 (NaN%)" || td[i].textContent == "NA [NA, NA]")
        td[i].textContent = "";
}
